...
export default function SignIn() {
  ...
  const handleSubmit = (event) => {
    ...
    let formSignInData = new FormData(event.currentTarget);
    setUserData({ ...userData, email: formSignInData.get("email"), password: formSignInData.get("password") });
  ...
  //!check and  log in and get all info about the user
  const handleHttp = async () => {
    const result = await axios.post("http://localhost:3003/api/logIn", userData);
